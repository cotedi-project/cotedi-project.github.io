...
config_path = os.environ.get("CATEGORY_RULE", "_system/forms/category_rule.yaml") # Read from environment variable, default to "forms/category_rule.yaml" if not set
